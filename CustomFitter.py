# -*- coding: utf-8 -*-
"""
Created on Wed Feb 14 00:57:24 2024
...
def Custom_fitter(filenames,title,xlimits,ylimits,txt,legend,gridlines,xlabel,ylabel,xcolumn,
    ...
    while(i < len(filenames)):
        ...
        z = np.polyfit(datalistX[i],datalistY[i],1) #obtain linear fit
